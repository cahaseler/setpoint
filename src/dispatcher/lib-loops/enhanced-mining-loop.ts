...
import { LibEnhancedMiningRun } from "../lib-compounds/enhanced-mining-run.js";
 ...
 * 2. LibEnhancedMiningRun — travel to belt, mine with jettison until cargo full
...
export async function runEnhancedMiningLoop(
	...
	const factory: LibGoalFactory = (_state: Readonly<GameState>): LibGoal => {
		...
		return new LibMiningIteration({
			...
			runGoal: new LibEnhancedMiningRun({
