...
import { LibGiftToPlayer } from "../lib-primitives/gift-to-player.js";
import { LibListCargoForSale } from "../lib-primitives/list-cargo-for-sale.js";
 ...
 */
export class LibUnloadAtStation implements LibGoal {
	...
	private buildUnloadSteps(ctx: LibGoalContext): LibGoal[] {
		switch (this.options.destType) {
			...
			case "faction-storage":
				...
				return [new LibSellOrDepositCargo({ depositTarget: "faction", skipMarket: true })];
